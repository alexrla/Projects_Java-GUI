...
public class Task {
    ...
    public Task(int id, int idProject, String name, String description, String notes, boolean status, Date deadline,
    ...
    public String toString() {
        return "Task{" + "id=" + id + ", idProject=" + idProject + ", name=" + name + ", description=" + description
                + ", notes=" + notes + ", status=" + status + ", deadline=" + deadline + ", createdAt=" + createdAt
                + ", updatedAt=" + updatedAt + '}';
    }
}
